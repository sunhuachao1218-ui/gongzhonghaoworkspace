...
export default function Home() {
  ...
  const runCommittee = async (stage = "topic", materials = committeeMaterials) => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:4174/api/reader-committee", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ project, stage, materials, readerContext: "陌生读者 · 知道你" }) });
