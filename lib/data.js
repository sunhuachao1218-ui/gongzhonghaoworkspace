...
export const SKILL_MAP = {
  topic: { name: "待配置", version: "—" }, cases: { name: "high-report-case-radar", version: "v1.3.0" },
  ...
  layout: { name: "gzh-layout", version: "未标注版本" }, cover: { name: "baoyu-cover-image", version: "v1.117.5" },
